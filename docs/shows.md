...
If the episode file contains an embedded cover art stream (attached picture), the **Video** tab shows a thumbnail preview of the image alongside its stream index and codec.
